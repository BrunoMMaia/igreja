        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-15">
                <Link href="/" className="mb-4 inline-block">
                  ...
                  />
                  <Image
                    src="/images/logo/FACHADA-02-1.png"
                    alt="logo"
                ...
                Nossa missão como família de Deus é crescer, avançar, e abençoar todos os povos da Terra. Temos um propósito muito maior que nós mesmos.
                </p>
